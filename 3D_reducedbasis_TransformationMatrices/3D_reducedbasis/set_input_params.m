function [RB_Con,RB_Eval,EIM_data] = set_input_params()
  ...
  RB_Eval.online_stage = true;
  mesh_num = 4;
  RB_Con.mesh_data_path = strcat('/home/2014-0004_focal_therapy/PhDs/AdapTT/Nikhil/DwarfElephant/libmesh_mesh_data_test/mesh_',num2str(mesh_num),'/');
  RB_Con.RB_matrix_path = strcat('/home/2014-0004_focal_therapy/PhDs/AdapTT/Nikhil/DwarfElephant/3DRBRFAMatrices/MeshConvMatrices/transienttestcase/mesh',num2str(mesh_num),'/');
  RB_Con.RB_F_vec_path = strcat('/home/2014-0004_focal_therapy/PhDs/AdapTT/Nikhil/DwarfElephant/3DRBRFAMatrices/MeshConvMatrices/transienttestcase/F_vectors/mesh',num2str(mesh_num),'/');
  ...
  RB_Con.time_end = 10*RB_Con.dt;%540.;%
  ...
  RB_Con.l_rel_tol = 1e-10;
  RB_Con.l_max_its = 50;
  RB_Eval.e_tol_min = 1e-2;%1E-6;
  RB_Eval.n_training_samples = 1;%30;
  ...
  RB_Eval.mu_bar('r') = 0.001414;
  RB_Eval.mu_bar('l') = 0.01871;
  ...
  RB_Eval.mu_bar('r_0') = 0.001414;
  RB_Eval.mu_bar('l_0') = 0.01871;  
  RB_Eval.mu_bar('needle_x') = 0.005;
  RB_Eval.mu_bar('needle_y') = 0.005;
  RB_Eval.mu_bar('needle_z') = 0.005;
  RB_Eval.mu_bar('needle_phi') = 0.05; 
  RB_Eval.mu_bar('needle_theta')  = 0.05;
  ...
  RB_Eval.mu_min('r') = 0.001414;
  RB_Eval.mu_min('l') = 0.01871;
  ...
  RB_Eval.mu_min('r_0') = 0.001;% 0.001414;
  RB_Eval.mu_min('l_0') = 0.015; % 0.01871; 
  RB_Eval.mu_min('needle_x') = 0;% -0.02;
  RB_Eval.mu_min('needle_y') = 0;% -0.02;
  RB_Eval.mu_min('needle_z') = 0;% -0.02;
  ...
  RB_Eval.mu_max('r') = 0.001414;
  RB_Eval.mu_max('l') = 0.01871; 
  ...
  RB_Eval.mu_max('r_0') = 0.002;%0.001414;
  RB_Eval.mu_max('l_0') = 0.02; %0.01871; 
  RB_Eval.mu_max('needle_x') = 0.01;%0.2 ;
  RB_Eval.mu_max('needle_y') = 0.01;%0.2 ;
  RB_Eval.mu_max('needle_z') = 0.01;%0.2 ;
  RB_Eval.mu_max('needle_phi') = 0.1;%1.57; 
  RB_Eval.mu_max('needle_theta') = 0.1;%1.57;

function [EIM_data] = load_EIM_data_PDSPL_max_max(EIM_data)
  file_path = EIM_data.EIM_data_path;
  test_str = ""; %"_test";% 
  B_matrix_filename = file_path + strcat("EIM_interpolation_matrix_PDSPL_max_max",test_str,".txt");
  ...
  int_points_filename = file_path + strcat("EIM_interpolation_points_PDSPL_max_max",test_str,".txt");
  ...
  int_points_subd_filename = file_path + strcat("EIM_interpolation_points_subdomain_PDSPL_max_max",test_str,".txt");

function [res_norm] = ResNormPara_Online_Result(CmuT_X_Cmu, CmuT_X_Amu, CmuT_X_Mmu, MmuT_X_Mmu, MmuT_X_Amu, MmuT_X_Cmu, AmuT_X_Amu, AmuT_X_Mmu, AmuT_X_Cmu, uN_k, uN_kPrev, gk, dt)

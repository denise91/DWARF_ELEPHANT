function [xyz, elem_nodes, num_nodes, num_elems, Permute_nodes] = read_libmesh_mesh_data(node_coords_file_base, node_connect_file_base)
    % Input Parameters
    ...
    while strcmp(err_msg,'') 
        elem_nodes_temp = fscanf(fileID,"%f",[5,Inf]);

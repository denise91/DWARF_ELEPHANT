function [mesh_node_coords_new] = deform_mesh(mesh_node_coords_old, subdomain_ids, element_node, r_new, l_new)
...
for node = 1:num_nodes
  ...
  elem_id = temp2(1);
  mesh_node_coords_new(:,node) = trafo_mat_cell{subdomain_ids(elem_id)}*mesh_node_coords_old(:,node) + trafo_vec_cell{subdomain_ids(elem_id)};
end

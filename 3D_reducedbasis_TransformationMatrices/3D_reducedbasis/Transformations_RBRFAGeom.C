extern "C" double NewCoord(double OldCoordX, double OldCoordY, double OldCoordZ, double r_0, double l_0, double L, double r, double l, int subdomain, int Coord_Required)
{

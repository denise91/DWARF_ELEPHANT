...
mesh_data_location = "/home/2014-0004_focal_therapy/PhDs/AdapTT/Nikhil/DwarfElephant/libmesh_mesh_data/PDSplit/{param_subd}/"#CHECK if testcase or not
mesh_file_base = "RBGeom_r{r:.3e}mm_l{l:.3e}mm_d_8by3r_h_4by3l_mesh2_RBPDSPL.msh"#CHECK if testcase or not
mesh_num = 2 # CHECK
for param_ref in r_l_new: 
  writeInputFile("Obtain_mesh_data.i",mesh_data_location.format(param_subd=param_ref[2]),mesh_file_base.format(r=param_ref[0],l=param_ref[1]),mesh_num)

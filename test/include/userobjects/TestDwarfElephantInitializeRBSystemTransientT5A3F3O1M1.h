...
class TestDwarfElephantRBEvaluationTransientT5A3F3O1M1;
class TestDwarfElephantInitializeRBSystemTransientT5A3F3O1M1;

///----------------------------INPUT PARAMETERS-----------------------------
template<>
InputParameters validParams<TestDwarfElephantRBEvaluationTransientT5A3F3O1M1>();
...
//----------------------------------PUBLIC----------------------------------
  public:
    TestDwarfElephantInitializeRBSystemTransientT5A3F3O1M1(const InputParameters & params);

...
class TestDwarfElephantRBEvaluationTransientT4A3F3O1M1;
class TestDwarfElephantInitializeRBSystemTransientT4A3F3O1M1;

///----------------------------INPUT PARAMETERS-----------------------------
template<>
InputParameters validParams<TestDwarfElephantRBEvaluationTransientT4A3F3O1M1>();
...
//----------------------------------PUBLIC----------------------------------
  public:
    TestDwarfElephantInitializeRBSystemTransientT4A3F3O1M1(const InputParameters & params);

 ...
 *  1. The number of thetas is equal to four (T4) and the number of Aq to three (A3).
...
struct TestDwarfElephantRBT4A3F3O1M1TransientExpansion : TransientRBThetaExpansion
{
  TestDwarfElephantRBT4A3F3O1M1TransientExpansion()
  {

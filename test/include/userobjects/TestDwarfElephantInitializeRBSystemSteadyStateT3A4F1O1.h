...
class TestDwarfElephantRBEvaluationSteadyStateT3A4F1O1;
class TestDwarfElephantInitializeRBSystemSteadyStateT3A4F1O1;
...
//----------------------------------PUBLIC----------------------------------
  public:
    TestDwarfElephantInitializeRBSystemSteadyStateT3A4F1O1(const InputParameters & params);

...
///-------------------------------------------------------------------------
#ifndef TESTDWARFELEPHANTRBSTRUCTUREST3F3O1STEADYSTATE_H
#define TESTDWARFELEPHANTRBSTRUCTUREST3F3O1STEADYSTATE_H
...
struct TestDwarfElephantRBT3F3O1SteadyStateExpansion : RBThetaExpansion
{
  TestDwarfElephantRBT3F3O1SteadyStateExpansion()
  {
  ...
  DwarfElephantThetaA4EqualMu4 _theta_f_1;
  RBTheta _rb_theta;         // Default RBTheta object, simply returns one.
};

///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST3F3O1STEADYSTATE_H

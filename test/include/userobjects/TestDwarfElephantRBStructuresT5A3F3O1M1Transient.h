 ...
 *  2. The problem contains three load vector (F3) and one output (O1).
 *
...
struct TestDwarfElephantRBT5A3F3O1M1TransientExpansion : TransientRBThetaExpansion
{
  TestDwarfElephantRBT5A3F3O1M1TransientExpansion()
  {
  ...
  DwarfElephantThetaEqualMu4 _theta_f_1;

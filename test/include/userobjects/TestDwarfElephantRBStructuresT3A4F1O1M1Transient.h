  ...
  *  1. The number of thetas is equal to three (T3) and the number of Aq to four (A4).
...
struct TestDwarfElephantRBT3A4F1O1M1TransientExpansion : TransientRBThetaExpansion
{
  TestDwarfElephantRBT3A4F1O1M1TransientExpansion()
  {

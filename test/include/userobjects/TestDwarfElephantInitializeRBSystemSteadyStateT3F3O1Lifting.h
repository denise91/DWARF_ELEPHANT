...
///-------------------------------------------------------------------------
#ifndef TESTDWARFELEPHANTINITIALIZERBSYSTEMSTEADYSTATET3F3O1LIFTING_H
#define TESTDWARFELEPHANTINITIALIZERBSYSTEMSTEADYSTATET3F3O1LIFTING_H
...
class TestDwarfElephantRBEvaluationSteadyStateT3F3O1Lifting;
class TestDwarfElephantInitializeRBSystemSteadyStateT3F3O1Lifting;
...
//----------------------------------PUBLIC----------------------------------
  public:
    TestDwarfElephantInitializeRBSystemSteadyStateT3F3O1Lifting(const InputParameters & params);
...
//     friend class DwarfElephantOfflineOnlineStageSteadyState;
    friend class TestDwarfElephantRBEvaluationSteadyStateT3F3O1Lifting;
...
///-------------------------------------------------------------------------
#endif // TESTDWARFELEPHANTINITIALIZERBSYSTEMSTEADYSTATET3F3O1Lifting_H

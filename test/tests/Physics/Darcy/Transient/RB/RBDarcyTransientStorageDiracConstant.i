...
[DiracKernels]
  [./Produktion]
    ...
    value = -0.02 # 200000 l/s (is divided by the reference length) Note the
...
[UserObjects]
[./initializeRBSystem]
  type = TestDwarfElephantInitializeRBSystemTransientT3A3F4O1M1
  execute_on = 'initial'
  N_max = 100
...
[../]
[./performRBSystem]
  type = TestDwarfElephantOfflineOnlineStageTransientT3A3F4O1M1

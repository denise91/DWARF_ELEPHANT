...
[UserObjects]
[./initializeRBSystem]
  type = TestDwarfElephantInitializeRBSystemTransientT4A3F3O1M1
  execute_on = 'initial'
  N_max = 100
  ...
  parameter_min_values = '1.0e-3 0.1 1.0e-3 1.0e2'
  parameter_max_values = '1.0e-1 10 1.0e-1 2.6e2'
...
[../]
[./performRBSystem]
  type = TestDwarfElephantOfflineOnlineStageTransientT4A3F3O1M1
  online_mu = '1.0e-2 1 1.0e-2 1.6e2'

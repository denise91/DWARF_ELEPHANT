...
[UserObjects]
  [./initializeRBSystem]
    type = TestDwarfElephantInitializeRBSystemSteadyStateT3A3F2O1Inverse
    execute_on = 'initial'
    N_max = 100
    ...
    parameter_min_values = '0.125 0.5 0.026 0.05'
    parameter_max_values = '0.375 1.5 0.081 0.15'
    normalize_rb_bound_in_greedy = true
    training_parameters_random_seed = 400
  [../]
  [./performRBSystem]
    type = TestDwarfElephantOfflineOnlineStageSteadyStateT3A3F2O1Inverse
    online_mu = '0.25 1.0 0.05357142857142857 0.1' # resistivity divided by reference value of 280 Ohm m

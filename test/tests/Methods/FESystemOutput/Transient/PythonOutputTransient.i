...
[UserObjects]
[./initializeRBSystem]
  type = TestDwarfElephantInitializeRBSystemTransientT3A3F1O1M1
  execute_on = 'initial'
  N_max = 100
...
[../]
[./performRBSystem]
  type = TestDwarfElephantOfflineOnlineStageTransientT3A3F1O1M1
...
perf_graph = true
  ...
  [../]
  [./matlab]
    type = DwarfElephantFEMatriciesAndVectorsPythonOutput
    ID_Aq = '0 1 2'
    print_inner_product_matrix = true
    print_Mq = true
    print_L2_matrix = true
  [../]
[]

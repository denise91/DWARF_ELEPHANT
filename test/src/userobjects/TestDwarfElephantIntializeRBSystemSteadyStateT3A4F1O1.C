...
#include "TestDwarfElephantInitializeRBSystemSteadyStateT3A4F1O1.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantInitializeRBSystemSteadyStateT3A4F1O1);

template<>
InputParameters validParams<TestDwarfElephantInitializeRBSystemSteadyStateT3A4F1O1>()
{
  InputParameters params = validParams<DwarfElephantInitializeRBSystemSteadyState>();
  return params;
}

TestDwarfElephantInitializeRBSystemSteadyStateT3A4F1O1::TestDwarfElephantInitializeRBSystemSteadyStateT3A4F1O1(const InputParameters & params):
  DwarfElephantInitializeRBSystemSteadyState(params)
{
}

void
TestDwarfElephantInitializeRBSystemSteadyStateT3A4F1O1::execute()
{
  ...
  if(_offline_stage)
  {
    ...
    TestDwarfElephantRBEvaluationSteadyStateT3A4F1O1 _rb_eval(_mesh_ptr->comm(), _fe_problem);

...
#include "TestDwarfElephantInitializeRBSystemSteadyStateT5A3F3O1.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantInitializeRBSystemSteadyStateT5A3F3O1);
...
TestDwarfElephantInitializeRBSystemSteadyStateT5A3F3O1::TestDwarfElephantInitializeRBSystemSteadyStateT5A3F3O1(const InputParameters & params):
  DwarfElephantInitializeRBSystemSteadyState(params)
{
}

void
TestDwarfElephantInitializeRBSystemSteadyStateT5A3F3O1::execute()
{
  ...
  if(_offline_stage)
  {
    ...
    TestDwarfElephantRBEvaluationSteadyStateT5A3F3O1 _rb_eval(_mesh_ptr->comm(), _fe_problem);

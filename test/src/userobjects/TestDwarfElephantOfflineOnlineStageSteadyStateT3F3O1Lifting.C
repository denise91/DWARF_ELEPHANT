...
#include "TestDwarfElephantOfflineOnlineStageSteadyStateT3F3O1Lifting.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantOfflineOnlineStageSteadyStateT3F3O1Lifting);
...
//-------------------------------CONSTRUCTOR-------------------------------
TestDwarfElephantOfflineOnlineStageSteadyStateT3F3O1Lifting::TestDwarfElephantOfflineOnlineStageSteadyStateT3F3O1Lifting(const InputParameters & params):
...
void
TestDwarfElephantOfflineOnlineStageSteadyStateT3F3O1Lifting::execute()
{
    // Build the RBEvaluation object
    // Required for both the Offline and Online stage.
    TestDwarfElephantRBEvaluationSteadyStateT3F3O1Lifting _rb_eval(comm() , _fe_problem);

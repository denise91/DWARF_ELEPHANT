...
#include "TestDwarfElephantOfflineOnlineStageTransientT3F3O1M1Lifting.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantOfflineOnlineStageTransientT3F3O1M1Lifting);
...
//-------------------------------CONSTRUCTOR-------------------------------
TestDwarfElephantOfflineOnlineStageTransientT3F3O1M1Lifting::TestDwarfElephantOfflineOnlineStageTransientT3F3O1M1Lifting(const InputParameters & params):
...
void
TestDwarfElephantOfflineOnlineStageTransientT3F3O1M1Lifting::execute()
{
    // Build the RBEvaluation object
    // Required for both the Offline and Online stage.
    TestDwarfElephantRBEvaluationTransientT3F3O1M1Lifting _rb_eval(comm() , _fe_problem);

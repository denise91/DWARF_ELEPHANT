...
#include "TestDwarfElephantOfflineOnlineStageSteadyStateT3F4O1.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantOfflineOnlineStageSteadyStateT3F4O1);

//----------------------------INPUT PARAMETERS-----------------------------
template<>
InputParameters validParams<TestDwarfElephantOfflineOnlineStageSteadyStateT3F4O1>()
{
...
//-------------------------------CONSTRUCTOR-------------------------------
TestDwarfElephantOfflineOnlineStageSteadyStateT3F4O1::TestDwarfElephantOfflineOnlineStageSteadyStateT3F4O1(const InputParameters & params):
...
void
TestDwarfElephantOfflineOnlineStageSteadyStateT3F4O1::execute()
{
    // Build the RBEvaluation object
    // Required for both the Offline and Online stage.
    TestDwarfElephantRBEvaluationSteadyStateT3F4O1 _rb_eval(comm() , _fe_problem);

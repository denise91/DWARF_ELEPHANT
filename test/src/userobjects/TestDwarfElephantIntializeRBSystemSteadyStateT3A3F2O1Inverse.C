...
#include "TestDwarfElephantInitializeRBSystemSteadyStateT3A3F2O1Inverse.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantInitializeRBSystemSteadyStateT3A3F2O1Inverse);

template<>
InputParameters validParams<TestDwarfElephantInitializeRBSystemSteadyStateT3A3F2O1Inverse>()
{
  InputParameters params = validParams<DwarfElephantInitializeRBSystemSteadyState>();
  return params;
}

TestDwarfElephantInitializeRBSystemSteadyStateT3A3F2O1Inverse::TestDwarfElephantInitializeRBSystemSteadyStateT3A3F2O1Inverse(const InputParameters & params):
  DwarfElephantInitializeRBSystemSteadyState(params)
{
}

void
TestDwarfElephantInitializeRBSystemSteadyStateT3A3F2O1Inverse::execute()
{
  ...
  if(_offline_stage)
  {
    ...
    TestDwarfElephantRBEvaluationSteadyStateT3A3F2O1Inverse _rb_eval(_mesh_ptr->comm(), _fe_problem);

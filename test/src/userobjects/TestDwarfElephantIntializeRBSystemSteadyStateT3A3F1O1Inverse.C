...
#include "TestDwarfElephantInitializeRBSystemSteadyStateT3A3F1O1Inverse.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantInitializeRBSystemSteadyStateT3A3F1O1Inverse);
...
TestDwarfElephantInitializeRBSystemSteadyStateT3A3F1O1Inverse::TestDwarfElephantInitializeRBSystemSteadyStateT3A3F1O1Inverse(const InputParameters & params):
  DwarfElephantInitializeRBSystemSteadyState(params)
{
}

void
TestDwarfElephantInitializeRBSystemSteadyStateT3A3F1O1Inverse::execute()
{
  ...
  if(_offline_stage)
  {
    ...
    TestDwarfElephantRBEvaluationSteadyStateT3A3F1O1Inverse _rb_eval(_mesh_ptr->comm(), _fe_problem);

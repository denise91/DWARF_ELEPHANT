...
#include "TestDwarfElephantInitializeRBSystemSteadyStateT3A3F3O1.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantInitializeRBSystemSteadyStateT3A3F3O1);

template<>
InputParameters validParams<TestDwarfElephantInitializeRBSystemSteadyStateT3A3F3O1>()
{
  InputParameters params = validParams<DwarfElephantInitializeRBSystemSteadyState>();
  return params;
}

TestDwarfElephantInitializeRBSystemSteadyStateT3A3F3O1::TestDwarfElephantInitializeRBSystemSteadyStateT3A3F3O1(const InputParameters & params):
  DwarfElephantInitializeRBSystemSteadyState(params)
{
}

void
TestDwarfElephantInitializeRBSystemSteadyStateT3A3F3O1::execute()
{
  ...
  if(_offline_stage)
  {
    ...
    TestDwarfElephantRBEvaluationSteadyStateT3A3F3O1 _rb_eval(_mesh_ptr->comm(), _fe_problem);

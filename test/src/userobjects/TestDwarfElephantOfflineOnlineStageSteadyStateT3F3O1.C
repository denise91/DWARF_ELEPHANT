...
#include "TestDwarfElephantOfflineOnlineStageSteadyStateT3F3O1.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantOfflineOnlineStageSteadyStateT3F3O1);
...
//-------------------------------CONSTRUCTOR-------------------------------
TestDwarfElephantOfflineOnlineStageSteadyStateT3F3O1::TestDwarfElephantOfflineOnlineStageSteadyStateT3F3O1(const InputParameters & params):
...
void
TestDwarfElephantOfflineOnlineStageSteadyStateT3F3O1::execute()
{
    // Build the RBEvaluation object
    // Required for both the Offline and Online stage.
    TestDwarfElephantRBEvaluationSteadyStateT3F3O1 _rb_eval(comm() , _fe_problem);

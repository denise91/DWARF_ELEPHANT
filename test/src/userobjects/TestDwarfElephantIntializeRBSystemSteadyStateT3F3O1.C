...
#include "TestDwarfElephantInitializeRBSystemSteadyStateT3F3O1.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantInitializeRBSystemSteadyStateT3F3O1);
...
TestDwarfElephantInitializeRBSystemSteadyStateT3F3O1::TestDwarfElephantInitializeRBSystemSteadyStateT3F3O1(const InputParameters & params):
  DwarfElephantInitializeRBSystemSteadyState(params)
{
}

void
TestDwarfElephantInitializeRBSystemSteadyStateT3F3O1::execute()
{
  ...
  if(_offline_stage)
  {
    ...
    TestDwarfElephantRBEvaluationSteadyStateT3F3O1 _rb_eval(_mesh_ptr->comm(), _fe_problem);

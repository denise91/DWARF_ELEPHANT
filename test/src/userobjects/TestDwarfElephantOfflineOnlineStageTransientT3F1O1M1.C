...
#include "TestDwarfElephantOfflineOnlineStageTransientT3F1O1M1.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantOfflineOnlineStageTransientT3F1O1M1);
...
//-------------------------------CONSTRUCTOR-------------------------------
TestDwarfElephantOfflineOnlineStageTransientT3F1O1M1::TestDwarfElephantOfflineOnlineStageTransientT3F1O1M1(const InputParameters & params):
...
void
TestDwarfElephantOfflineOnlineStageTransientT3F1O1M1::execute()
{
    // Build the RBEvaluation object
    // Required for both the Offline and Online stage.
    TestDwarfElephantRBEvaluationTransientT3F1O1M1 _rb_eval(comm() , _fe_problem);

...
#include "TestDwarfElephantOfflineOnlineStageTransientT3A3F3O1M1.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantOfflineOnlineStageTransientT3A3F3O1M1);

//----------------------------INPUT PARAMETERS-----------------------------
template<>
InputParameters validParams<TestDwarfElephantOfflineOnlineStageTransientT3A3F3O1M1>()
{
...
//-------------------------------CONSTRUCTOR-------------------------------
TestDwarfElephantOfflineOnlineStageTransientT3A3F3O1M1::TestDwarfElephantOfflineOnlineStageTransientT3A3F3O1M1(const InputParameters & params):
...
void
TestDwarfElephantOfflineOnlineStageTransientT3A3F3O1M1::execute()
{
    // Build the RBEvaluation object
    // Required for both the Offline and Online stage.
    TestDwarfElephantRBEvaluationTransientT3A3F3O1M1 _rb_eval(comm() , _fe_problem);

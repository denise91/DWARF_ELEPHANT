...
#include "TestDwarfElephantOfflineOnlineStageSteadyStateT3A3F1O1Inverse.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantOfflineOnlineStageSteadyStateT3A3F1O1Inverse);
...
//-------------------------------CONSTRUCTOR-------------------------------
TestDwarfElephantOfflineOnlineStageSteadyStateT3A3F1O1Inverse::TestDwarfElephantOfflineOnlineStageSteadyStateT3A3F1O1Inverse(const InputParameters & params):
...
void
TestDwarfElephantOfflineOnlineStageSteadyStateT3A3F1O1Inverse::execute()
{
    // Build the RBEvaluation object
    // Required for both the Offline and Online stage.
    TestDwarfElephantRBEvaluationSteadyStateT3A3F1O1Inverse _rb_eval(comm() , _fe_problem);

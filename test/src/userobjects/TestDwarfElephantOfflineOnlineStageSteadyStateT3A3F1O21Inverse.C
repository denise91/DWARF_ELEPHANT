...
#include "TestDwarfElephantOfflineOnlineStageSteadyStateT3A3F1O21Inverse.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantOfflineOnlineStageSteadyStateT3A3F1O21Inverse);
...
//-------------------------------CONSTRUCTOR-------------------------------
TestDwarfElephantOfflineOnlineStageSteadyStateT3A3F1O21Inverse::TestDwarfElephantOfflineOnlineStageSteadyStateT3A3F1O21Inverse(const InputParameters & params):
...
void
TestDwarfElephantOfflineOnlineStageSteadyStateT3A3F1O21Inverse::execute()
{
    // Build the RBEvaluation object
    // Required for both the Offline and Online stage.
    TestDwarfElephantRBEvaluationSteadyStateT3A3F1O21Inverse _rb_eval(comm() , _fe_problem);

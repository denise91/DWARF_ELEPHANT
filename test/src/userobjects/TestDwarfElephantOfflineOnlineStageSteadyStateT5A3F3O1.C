...
#include "TestDwarfElephantOfflineOnlineStageSteadyStateT5A3F3O1.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantOfflineOnlineStageSteadyStateT5A3F3O1);
...
//-------------------------------CONSTRUCTOR-------------------------------
TestDwarfElephantOfflineOnlineStageSteadyStateT5A3F3O1::TestDwarfElephantOfflineOnlineStageSteadyStateT5A3F3O1(const InputParameters & params):
...
void
TestDwarfElephantOfflineOnlineStageSteadyStateT5A3F3O1::execute()
{
    // Build the RBEvaluation object
    // Required for both the Offline and Online stage.
    TestDwarfElephantRBEvaluationSteadyStateT5A3F3O1 _rb_eval(comm() , _fe_problem);

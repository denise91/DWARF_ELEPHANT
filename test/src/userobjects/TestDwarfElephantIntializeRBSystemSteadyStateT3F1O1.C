...
#include "TestDwarfElephantInitializeRBSystemSteadyStateT3F1O1.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantInitializeRBSystemSteadyStateT3F1O1);
...
TestDwarfElephantInitializeRBSystemSteadyStateT3F1O1::TestDwarfElephantInitializeRBSystemSteadyStateT3F1O1(const InputParameters & params):
  DwarfElephantInitializeRBSystemSteadyState(params)
{
}

void
TestDwarfElephantInitializeRBSystemSteadyStateT3F1O1::execute()
{
  ...
  if(_offline_stage)
  {
    ...
    TestDwarfElephantRBEvaluationSteadyStateT3F1O1 _rb_eval(_mesh_ptr->comm(), _fe_problem);

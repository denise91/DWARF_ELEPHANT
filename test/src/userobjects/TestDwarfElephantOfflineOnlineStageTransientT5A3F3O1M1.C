...
#include "TestDwarfElephantOfflineOnlineStageTransientT5A3F3O1M1.h"

registerMooseObject("DwarfElephantApp", TestDwarfElephantOfflineOnlineStageTransientT5A3F3O1M1);
...
//-------------------------------CONSTRUCTOR-------------------------------
TestDwarfElephantOfflineOnlineStageTransientT5A3F3O1M1::TestDwarfElephantOfflineOnlineStageTransientT5A3F3O1M1(const InputParameters & params):
...
void
TestDwarfElephantOfflineOnlineStageTransientT5A3F3O1M1::execute()
{
    // Build the RBEvaluation object
    // Required for both the Offline and Online stage.
    TestDwarfElephantRBEvaluationTransientT5A3F3O1M1 _rb_eval(comm() , _fe_problem);

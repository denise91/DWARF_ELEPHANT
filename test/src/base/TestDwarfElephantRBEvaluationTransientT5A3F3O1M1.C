...
#include "libmesh/xdr_cxx.h"
  ...
  TestDwarfElephantRBEvaluationTransientT5A3F3O1M1::TestDwarfElephantRBEvaluationTransientT5A3F3O1M1(const libMesh::Parallel::Communicator & comm, FEProblemBase & fe_problem):

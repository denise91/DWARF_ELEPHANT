...
\begin{figure}
\center
\includegraphics[width=0.7\textwidth]{Figures/no_fault_model}
...
\hline\noalign{\smallskip}
unit & thermal conductivity [W m\textsuperscript{-1}  K\textsuperscript{-1}] / & \multicolumn{3}{c|}{extension in}\\
\cline{3-5}

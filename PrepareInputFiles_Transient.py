from HelperModule_Transient import *

AqObjectsList = []
MqObjectsList = []

BilinearForms = ['TimeDerivative', 'Diffusion', 'Perfusion', 'Convection']
...
RBThetaExpansionCFileName = "/home/2014-0004_focal_therapy/PhDs/AdapTT/Nikhil/DwarfElephant/include/userobjects/DwarfElephantGeom3DTransientRBThetaExpansion_RFA.h" #(EDIT FOR 3D GEOM)
IncludeFileName = ["DwarfElephantGeom3DRBTheta_RFA.h", "DwarfElephantMeshSubdomainJacobians.h"] #(EDIT FOR 3D GEOM)
IncludeGaurdName = "DWARFELEPHANTGEOM3DTRANSIENTRBTHETAEXPANSION_RFA_H" #(EDIT FOR 3D GEOM)

 ...
 *  2. The problem contains two Fq (F2) and 12 outputs (O12).
 *
...
struct DwarfElephantRBT2A2F2O12M1TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT2A2F2O12M1TransientExpansion()
  {

 ...
 *  2. The problem contains ten Fq (F10) and 80 outputs (O80).
 *
...
struct DwarfElephantRBT9A9F10O80SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT9A9F10O80SteadyStateExpansion()
  {

 ...
 *  2. The problem contains four Fq (F4) and one outputs (O1).
 *
...
struct DwarfElephantRBT3A3F4O1M2TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT3A3F4O1M2TransientExpansion()
  {

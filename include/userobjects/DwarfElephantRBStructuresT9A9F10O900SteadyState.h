 ...
 *  2. The problem contains ten Fq (F10) and 900 outputs (O900).
 *
...
struct DwarfElephantRBT9A9F10O900SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT9A9F10O900SteadyStateExpansion()
  {

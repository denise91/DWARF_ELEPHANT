 ...
 *  1. The number of thetas is equal to 15 (T15) and the number of Aq to nine (A9).
 *  2. The problem contains eight Fq (F8) and 80 outputs (O80).
 *
...
struct DwarfElephantRBT15A9F8O80SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT15A9F8O80SteadyStateExpansion()
  {

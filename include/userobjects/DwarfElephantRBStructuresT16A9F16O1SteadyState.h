 ...
 *  2. The problem contains 16 Fq (F16) and one output (O1).
 *
...
struct DwarfElephantRBT16A9F16O1SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT16A9F16O1SteadyStateExpansion()
  {

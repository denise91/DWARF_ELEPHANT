 ...
 *  2. The problem contains seven Fq (F7) and one output (O1).
 *
...
struct DwarfElephantRBT9A3F7O1SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT9A3F7O1SteadyStateExpansion()
  {

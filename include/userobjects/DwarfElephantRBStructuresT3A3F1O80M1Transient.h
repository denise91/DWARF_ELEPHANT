 ...
 *  2. The problem contains one Fq (F1) and 80 outputs (O80).
 *
...
struct DwarfElephantRBT3A3F1O80M1TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT3A3F1O80M1TransientExpansion()
  {

 ...
 *  1. The number of thetas is equal to 12 (T12) and the number of Aq to 12 (A12).
 *  2. The problem contains 13 Fq (F13) and 20 outputs (O20).
 *
...
struct DwarfElephantRBT12A12F13O20SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT12A12F13O20SteadyStateExpansion()
  {

 ...
 *  2. The problem contains three Fq (F3) and one output (O1).
 *
...
struct DwarfElephantRBT5A3F3O1SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT5A3F3O1SteadyStateExpansion()
  {

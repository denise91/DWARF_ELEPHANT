 ...
 *  2. The problem contains nine Fq (F9) and 980 outputs (O980).
 *
...
struct DwarfElephantRBT8A8F9O980SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT8A8F9O980SteadyStateExpansion()
  {

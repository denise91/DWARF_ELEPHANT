 ...
 *  1. The number of thetas is equal to eight (T8) and the number of Aq to eight (A8).
 *  2. The problem contains nine Fq (F9) and 2347 outputs (O2347).
 *
...
struct DwarfElephantRBT8A8F9O2385SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT8A8F9O2385SteadyStateExpansion()
  {

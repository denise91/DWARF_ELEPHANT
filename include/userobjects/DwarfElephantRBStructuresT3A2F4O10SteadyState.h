 ...
 *  1. The number of thetas is equal to three (T3) and the number of Aq to two (A2).
 *  2. The problem contains four Fq (F4) and ten output (O10).
 *
...
struct DwarfElephantRBT3A2F4O10SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT3A2F4O10SteadyStateExpansion()
  {

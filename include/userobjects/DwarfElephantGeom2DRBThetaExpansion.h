...
struct Geom2DRBThetaExpansion : RBThetaExpansion
{
  ...
  attach_F_theta(&Geom2DRB_FTheta_HeatSource_maxZ1_0);
  attach_F_theta(&Geom2DRB_FTheta_HeatSource_maxZ2_0);
  attach_F_theta(&Geom2DRB_FTheta_HeatSource_maxX1_0);
  attach_F_theta(&Geom2DRB_FTheta_HeatSource_maxX2_0);
  attach_F_theta(&Geom2DRB_FTheta_HeatSource_minZ1_0);
  attach_F_theta(&Geom2DRB_FTheta_HeatSource_minZ2_0);
  attach_F_theta(&Geom2DRB_FTheta_HeatSource_minX1_0);
  attach_F_theta(&Geom2DRB_FTheta_HeatSource_minX2_0);
  attach_F_theta(&Geom2DRB_FTheta_HeatSource_BoundingBox_0);
  }
  RBTheta _rb_theta;
  ...
  Geom2DRB_FTheta_HeatSource_maxZ1 Geom2DRB_FTheta_HeatSource_maxZ1_0;
  Geom2DRB_FTheta_HeatSource_maxZ2 Geom2DRB_FTheta_HeatSource_maxZ2_0;
  Geom2DRB_FTheta_HeatSource_maxX1 Geom2DRB_FTheta_HeatSource_maxX1_0;
  Geom2DRB_FTheta_HeatSource_maxX2 Geom2DRB_FTheta_HeatSource_maxX2_0;
  Geom2DRB_FTheta_HeatSource_minZ1 Geom2DRB_FTheta_HeatSource_minZ1_0;
  Geom2DRB_FTheta_HeatSource_minZ2 Geom2DRB_FTheta_HeatSource_minZ2_0;
  Geom2DRB_FTheta_HeatSource_minX1 Geom2DRB_FTheta_HeatSource_minX1_0;
  Geom2DRB_FTheta_HeatSource_minX2 Geom2DRB_FTheta_HeatSource_minX2_0;
  Geom2DRB_FTheta_HeatSource_BoundingBox Geom2DRB_FTheta_HeatSource_BoundingBox_0;
};

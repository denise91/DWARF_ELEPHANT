 ...
 *  2. The problem contains five Fq (F5) and one output (O1).
 *
...
struct DwarfElephantRBT6A5F5O1M1IC1TransientExpansion : DwarfElephantRBTransientThetaExpansion
{
  DwarfElephantRBT6A5F5O1M1IC1TransientExpansion()
  {

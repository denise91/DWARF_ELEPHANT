 ...
 *  1. The number of thetas is equal to 27 (T27) and the number of Aq to 13 (A13).
 *  2. The problem contains 14 Fq (F14) and 84 outputs (O84).
 *
...
struct DwarfElephantRBT27A13F14O84SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT27A13F14O84SteadyStateExpansion()
  {

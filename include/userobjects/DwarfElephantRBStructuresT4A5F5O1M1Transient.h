 ...
 *  1. The number of thetas is equal to four (T4) and the number of Aq to five (A5).
...
struct DwarfElephantRBT4A5F5O1M1TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT4A5F5O1M1TransientExpansion()
  {

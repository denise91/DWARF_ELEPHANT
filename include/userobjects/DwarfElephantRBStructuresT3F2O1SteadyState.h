  ...
  *  2. The problem contains two load vectors (F2) and one output (O1).
  *
...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST3F2O1STEADYSTATE_H
#define DWARFELEPHANTRBSTRUCTUREST3F2O1STEADYSTATE_H
...
///The structures are defined for an elliptic PDE with the following restrictions: 1. The number of thetas is equal to three (T3). 2. The problem contains two load vectors (F2) and one output (O1).
...
struct DwarfElephantRBT3F2O1SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT3F2O1SteadyStateExpansion()
  {
  ...
  DwarfElephantThetaA0EqualScalarDividedByMu0 _theta_f_0;
  RBTheta _rb_theta;         // Default RBTheta object, simply returns one.
};

///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST3F2O1STEADYSTATE_H

 ...
 *  2. The problem contains six Fq (F6) and one output (O1).
 *
...
struct DwarfElephantRBT6A6F6O1M1TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT6A6F6O1M1TransientExpansion()
  {
  ...
  // DwarfElephantThetaEqualMu1 _theta_m_0;

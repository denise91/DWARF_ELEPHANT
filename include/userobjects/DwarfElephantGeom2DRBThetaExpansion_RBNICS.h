...
struct Geom2DRBThetaExpansion : RBThetaExpansion
{
  ...
  attach_F_theta(&Geom2DRB_FTheta_NeumannBC_max_z_line_inner_0);
  attach_F_theta(&Geom2DRB_FTheta_NeumannBC_max_x_line_inner_0);
  attach_F_theta(&Geom2DRB_FTheta_NeumannBC_min_z_line_inner_0);
  attach_F_theta(&Geom2DRB_FTheta_NeumannBC_min_x_line_inner_0);
  }
  RBTheta _rb_theta;
  ...
  Geom2DRB_FTheta_NeumannBC_max_z_line_inner Geom2DRB_FTheta_NeumannBC_max_z_line_inner_0;
  Geom2DRB_FTheta_NeumannBC_max_x_line_inner Geom2DRB_FTheta_NeumannBC_max_x_line_inner_0;
  Geom2DRB_FTheta_NeumannBC_min_z_line_inner Geom2DRB_FTheta_NeumannBC_min_z_line_inner_0;
  Geom2DRB_FTheta_NeumannBC_min_x_line_inner Geom2DRB_FTheta_NeumannBC_min_x_line_inner_0;
};

 ...
 *  2. The problem contains one Fq (F1) and 81 outputs (O81).
 *
...
struct DwarfElephantRBT6A6F1O81SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT6A6F1O81SteadyStateExpansion()
  {

...
struct Geom2DRB_FTheta_NeumannBC_max_z_line_inner : RBTheta
{
  virtual Number evaluate (const RBParameters & _mu)
  {
    double r = 0.3;
    return _mu.get_value("mu_0")/r;
  }
};
struct Geom2DRB_FTheta_NeumannBC_max_x_line_inner : RBTheta
{
  virtual Number evaluate (const RBParameters & _mu)
  {
  double  l = 0.6;
    return _mu.get_value("mu_1")/l;
  }
};
struct Geom2DRB_FTheta_NeumannBC_min_z_line_inner : RBTheta
{
  virtual Number evaluate (const RBParameters & _mu)
  {
    double r = 0.3;
...
struct Geom2DRB_FTheta_NeumannBC_min_x_line_inner : RBTheta
{
  virtual Number evaluate (const RBParameters & _mu)
  {
  double  l = 0.6;

 ...
 *  1. The number of thetas is equal to 15 (T15) and the number of Aq to eight (A8).
 *  2. The problem contains 16 Fq (F16) and 2385 outputs (O2385).
 *
...
struct DwarfElephantRBT15A8F16O2385SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT15A8F16O2385SteadyStateExpansion()
  {

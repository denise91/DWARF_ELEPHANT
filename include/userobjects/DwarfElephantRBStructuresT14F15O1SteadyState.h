  ...
  *  2. The problem contains 15 load vectors (F15) and 1 outputs (O1).
  *
...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST14F15O1STEADYSTATE_H
#define DWARFELEPHANTRBSTRUCTUREST14F15O1STEADYSTATE_H
...
struct DwarfElephantRBT14F15O1SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT14F15O1SteadyStateExpansion()
  {

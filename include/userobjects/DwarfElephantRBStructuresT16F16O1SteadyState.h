  ...
  *  2. The problem contains 16 load vectors (F16) and one output (O1).
  *
...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST16F16O1STEADYSTATE_H
#define DWARFELEPHANTRBSTRUCTUREST16F16O1STEADYSTATE_H
...
struct DwarfElephantRBT16F16O1SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT16F16O1SteadyStateExpansion()
  {

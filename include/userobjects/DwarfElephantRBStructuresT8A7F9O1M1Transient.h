 ...
 *  1. The number of thetas is equal to eight (T8) and the number of Aq to seven (A7).
...
struct DwarfElephantRBT8A7F9O1M1TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT8A7F9O1M1TransientExpansion()
  {

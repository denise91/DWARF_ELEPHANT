 ...
 *  2. The problem contains two Fq (F2) and 80 outputs (O80).
 *
...
struct DwarfElephantRBT9A9F2O80SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT9A9F2O80SteadyStateExpansion()
  {

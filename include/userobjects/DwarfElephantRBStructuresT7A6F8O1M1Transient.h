 ...
 *  1. The number of thetas is equal to seven (T7) and the number of Aq to six (A6).
 *  2. The problem contains eigth Fq (F8) and one output (O1).
 *
...
struct DwarfElephantRBT7A6F8O1M1TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT7A6F8O1M1TransientExpansion()
  {

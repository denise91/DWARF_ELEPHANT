 ...
 *  2. The problem contains 13 Fq (F13) and one output (O1).
 *
...
struct DwarfElephantRBT12A12F13O1SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT12A12F13O1SteadyStateExpansion()
  {

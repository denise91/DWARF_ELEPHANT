 ...
 *  1. The number of thetas is equal to three (T3) and the number of Aq to one (A1).
 *  2. The problem contains four Fq (F4) and ten outputs (O10).
 *
...
#include "DwarfElephantRBStructuresThetaEqualMu2TimesMu0.h"
...
struct DwarfElephantRBT3A1F4O10SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT3A1F4O10SteadyStateExpansion()
  {

 ...
 *  1. The number of thetas is equal to 14 (T14) and the number of Aq to eight (A8).
 *  2. The problem contains 15 Fq (F15) and one output (O1).
 *
...
struct DwarfElephantRBT14A8F15O1SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT14A8F15O1SteadyStateExpansion()
  {

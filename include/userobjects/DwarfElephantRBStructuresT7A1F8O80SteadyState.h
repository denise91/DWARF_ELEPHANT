 ...
 *  1. The number of thetas is equal to seven (T7) and the number of Aq to one (A1).
...
struct DwarfElephantRBT7A1F8O80SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT7A1F8O80SteadyStateExpansion()
  {

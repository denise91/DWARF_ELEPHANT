 ...
 *  2. The problem contains three Fq (F3) and three output (O3).
 *
...
struct DwarfElephantRBT3A3F3O3M2IC1TransientExpansion : DwarfElephantRBTransientThetaExpansion
{
  DwarfElephantRBT3A3F3O3M2IC1TransientExpansion()
  {

 ...
 *  2. The problem contains one Fq (F1) and three output (O3).
 *
...
struct DwarfElephantRBT2A2F1O3M2TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT2A2F1O3M2TransientExpansion()
  {

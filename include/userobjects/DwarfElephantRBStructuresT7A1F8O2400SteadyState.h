 ...
 *  2. The problem contains eigth Fq (F8) and 2400 outputs (O2400).
 *
...
struct DwarfElephantRBT7A1F8O2400SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT7A1F8O2400SteadyStateExpansion()
  {

 ...
 *  2. The problem contains nine Fq (F9) and ten outputs (O10).
 *
...
struct DwarfElephantRBT8A2F9O10SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT8A2F9O10SteadyStateExpansion()
  {

  ...
  */
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST4F1O1M1TRANSIENT_H
#define DWARFELEPHANTRBSTRUCTUREST4F1O1M1TRANSIENT_H
...
///The structures are defined for an parabolic PDE with the following restrictions: 1. The number of thetas is equal to four (T4). 2. The problem contains one load vector (F1) and one output (O1).
...
struct DwarfElephantRBT4F1O1M1TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT4F1O1M1TransientExpansion()
  {
...
///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST4F1O1M1Transient_H

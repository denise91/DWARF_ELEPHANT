 ...
 *  2. The problem contains two Fq (F2) and ten outputs (O10).
 *
...
struct DwarfElephantRBT2A2F2O10SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT2A2F2O10SteadyStateExpansion()
  {

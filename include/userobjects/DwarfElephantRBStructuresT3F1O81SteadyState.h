  ...
  *  2. The problem contains one load vector (F1) and 81 output (O81).
  *
...
///-------------------------------------------------------------------------
#ifndef DWARFELEPHANTRBSTRUCTUREST3F1O81STEADYSTATE_H
#define DWARFELEPHANTRBSTRUCTUREST3F1O81STEADYSTATE_H
...
struct DwarfElephantRBT3F1O81SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT3F1O81SteadyStateExpansion()
  {
...
///-------------------------------------------------------------------------
#endif // DWARFELEPHANTRBSTRUCTUREST3F1O81STEADYSTATE_H

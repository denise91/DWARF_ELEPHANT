 ...
 *  2. The problem contains one Fq (F1) and three outputs (O3).
 *
...
struct DwarfElephantRBT3A3F1O3M1TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT3A3F1O3M1TransientExpansion()
  {

 ...
 *  1. The number of thetas is equal to six (T6) and the number of Aq to five (A5).
 *  2. The problem contains five Fq (F5) and 27 outputs (O27).
 *
...
struct DwarfElephantRBT6A5F5O27M1IC1TransientExpansion : DwarfElephantRBTransientThetaExpansion
{
  DwarfElephantRBT6A5F5O27M1IC1TransientExpansion()
  {

 ...
 *  2. The problem contains one Fq (F1) and one outputs (O1).
 *
...
struct DwarfElephantRBT3A3F1O1M1TransientExpansion : TransientRBThetaExpansion
{
  DwarfElephantRBT3A3F1O1M1TransientExpansion()
  {

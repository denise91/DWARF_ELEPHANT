 ...
 *  1. The number of thetas is equal to seven (T7) and the number of Aq to eigth (A8).
 *  2. The problem contains eigth Fq (F8) and 2385 outputs (O2385).
 *
...
struct DwarfElephantRBT7A8F8O2385SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT7A8F8O2385SteadyStateExpansion()
  {

 ...
 *  2. The problem contains eigth Fq (F8) and 4747 outputs (O4747).
 *
...
struct DwarfElephantRBT7A1F8O4747SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT7A1F8O4747SteadyStateExpansion()
  {

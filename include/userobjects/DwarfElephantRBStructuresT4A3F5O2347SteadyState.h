 ...
 *  2. The problem contains five Fq (F5) and 2347 outputs (O2347).
 *
...
struct DwarfElephantRBT4A3F5O2347SteadyStateExpansion : RBThetaExpansion
{
  DwarfElephantRBT4A3F5O2347SteadyStateExpansion()
  {
  ...
  DwarfElephantThetaEqualMu3 _theta_f_1;
